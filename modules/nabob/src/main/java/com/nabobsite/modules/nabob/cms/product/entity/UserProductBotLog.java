 ...
 * @version 2021-05-17
 */
@Table(name="t1_user_product_bot_log", alias="a", columns={
		...
		@Column(name="income_money", attrName="incomeMoney", label="收入"),
...
public class UserProductBotLog extends DataEntity<UserProductBotLog> {
	...
	private BigDecimal incomeMoney;		// 收入
	private BigDecimal incomeRate;		// 收益比例
	private Date created;		// 创建时间
	private Date updated;		// 更新时间
	private String delFlag;		// 删除标志
	
	public UserProductBotLog() {
		this(null);
	}

	public UserProductBotLog(String id){
		super(id);
	}
