...
*/
public class UserWarehouseIncomeTrigger extends TriggerOperation {

	private BigDecimal updateMoney;
	private LogicService logicService;

	public UserWarehouseIncomeTrigger(String userId,BigDecimal updateMoney, UserInfoDao userInfoDao, LogicService logicService) {
	...
	@Override
	public void execute() {
		logger.info("用户动态收益触发器，userId:{},type:{},money:{}",userId,updateMoney);
