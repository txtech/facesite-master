...
@Table(name="t1_product_bot", alias="a", columns={
		...
		@Column(name="price", attrName="price", label="产品价格"),
		...
		@Column(name="title", attrName="title", label="产品标题", queryType=QueryType.LIKE),
...
public class ProductBot extends DataEntity<ProductBot> {
	...
	@Length(min=0, max=1024, message="产品标题长度不能超过 1024 个字符")
	...
	@Length(min=0, max=3200, message="产品描述长度不能超过 3200 个字符")
