...
public class SnowFlakeIDGenerator {
    ...
    public static void main(String[] args) {
        //System.out.println(System.currentTimeMillis()); // 1288834974657L  1609335223774L
        long startTime = System.nanoTime();
        for (int i = 0; i < 5; i++) {
            long id = SnowFlakeIDGenerator.generateSnowFlakeId();
     ...
     */
    public static synchronized int getRandom6(){
    ...
    static class SnowFlake{
        ...
        /** 开始时间截 (2020-12-30)*/
        private final static long twepoch = 1609335223774L;
        // 机器标识位数 机器id所占的位数
        ...
        protected static long getDatacenterId(long maxDatacenterId) {
            ...
            try {
                ...
                System.out.println("Exception getDatacenterId: " + e.getMessage());
            }
            return id;
        }
    }
