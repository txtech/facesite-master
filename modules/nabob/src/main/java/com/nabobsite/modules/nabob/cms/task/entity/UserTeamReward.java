 ...
 * @version 2021-05-17
 */
@Table(name="t1_user_team_reward", alias="a", columns={
...
public class UserTeamReward extends DataEntity<UserTeamReward> {
	...
	public UserTeamReward() {
		this(null);
	}

	public UserTeamReward(String id){
		super(id);
	}
